            ...
            do {
                ...
                if (cursor.getString(6) != null) {
                    try {
                        ...
                        JSONArray jsonArrayPeopleKilled = jsonParents.getJSONArray("parents");
                        if (jsonArrayPeopleKilled != null) {
                            for (int i = 0; i < jsonArrayPeopleKilled.length(); i++) {
                                parents.add(jsonArrayPeopleKilled.optString(i));
                            }
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                    ...
                    try {
                        ...
                        if (jsonArraySpouse != null) {
                            for (int i = 0; i < jsonArraySpouse.length(); i++) {
                                peopleKilled.add(jsonArraySpouse.optString(i));
                            }
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
